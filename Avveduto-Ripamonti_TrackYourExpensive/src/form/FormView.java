...
class FormView {
    ...
    FormView(PApplet processing, ControlP5 cp5){
        ...
        passwordField = cp5.addTextfield("password").setColorForeground(processing.color(255)).setFont(processing.createFont("arial",25)).setPosition(processing.width/2-100,processing.height/2+40).setSize(200,40).setFocus(true).setColor(processing.color(255)).setColorActive(processing.color(255)).setColorBackground(0).setCaptionLabel("").hide();
